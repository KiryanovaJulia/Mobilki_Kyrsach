...
public class ChatActivity extends BaseActivity {
    ...
    /**
     * Инициализирует переменные и настройки активности.
     */
    private void init() {
    ...
    /**
     * Отображает сообщение в виде всплывающего уведомления.
     *
    ...
    /**
     * Слушает доступность получателя сообщений.
     */
    ...
    /**
     * Получает изображение из закодированной строки.
     *
     * @param encodedImage закодированное изображение
     * @return изображение в формате Bitmap
     */
    ...
    /**
     * Загружает детали получателя сообщений.
     */
    ...
    /**
     * Устанавливает слушатели на элементы интерфейса.
     */
    ...
    /**
     * Получает читабельное представление даты и времени.
     *
    ...
    /**
     * Добавляет новую беседу в базу данных.
     *
     * @param conversion беседа
     */
    ...
    /**
     * Проверяет наличие беседы между отправителем и получателем.
     */
